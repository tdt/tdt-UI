...
$app->match('/ui/package/add{url}', function (Request $request) use ($app,$hostname,$data) {
    ...
    $form = $form->add('add','submit',array('label' => 'add','attr' => array('class' => 'btnother')));
    $form = $form->add('addOpt','submit',array('label' => 'add Optional parameters' ,'attr' => array('class' => 'btnother')));
